...
const PointSalesForm = ({
    ...
    //Data State
    const [ pointSale , setPointSale ] =  useState(data || {})
    //Trigger State
    ...
    const validationData = useFormik({
        ...
        initialValues: {
            codigo: (pointSale && pointSale.codigo) || "",
            nombre : (pointSale && pointSale.nombre) || "",
            interno : (pointSale && pointSale.interno) || ""
        },
        ...
        <ModalBody className="apply-modal-content">
            ...
            <Form autoComplete="off" className="default-form job-apply-form">
                <Row className='mb-sm-2'>
                    ...
                    <Col className="col-12">
                        <div className="form-group mb-2">
                            <Label className="form-label">Cód. Interno</Label>
                            <Input 
                                id="txtInterno_field"
                                name="interno"
                                className={"form-control"}
                                ...
                                onBlur={ validationData.handleBlur }
                                onChange={ validationData.handleChange }
                                value={validationData.values.interno || ""} />
                        </div>
                    </Col>
                </Row>
            </Form>
