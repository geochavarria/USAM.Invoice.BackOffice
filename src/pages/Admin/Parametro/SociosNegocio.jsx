...
import { getAllSocioNegocioAsync } from "@/helpers/backend_helpers/admin_helpers";
...
const SociosNegocio = () => {
            ...
            },
            {
                ...
                cell : ({ row }) => (
                    <div className="d-flex flex-column">
                        <a  href="#"
                            className="fw-medium fs-13 link-primary"> {row.original.nombre}</a>
                    </div>
                )
            },
            {
    ...
    const onLoadAsync = async() =>{
        try {
            const response = await getAllSocioNegocioAsync();
    ...
    return(<React.Fragment>
        ...
        <CustomTable
            ...
            tableClass="table align-middle table-nowrap mb-0 table-striped table-sm table-hover"
